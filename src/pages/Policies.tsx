...
const PolicyPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white dark:from-gray-900 dark:to-gray-950">
      <div className="container py-16 px-4 md:px-6 max-w-6xl mx-auto">
        <header className="mb-12 text-center">
          <h1 className="text-4xl font-bold tracking-tight mb-4">
            Användarvillkor och Policyer
          </h1>
          <p className="text-xl text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
            Vårt engagemang för säkerhet, integritet och transparens
          </p>
        </header>

        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-1">
            <Card className="p-4 sticky top-8 apple-card border-0 shadow-sm">
              <div className="space-y-2">
                ...
                >
                  ...
                  <span className="font-medium">Integritetspolicy</span>
                </button>
                <button
                ...
                >
                  ...
                  <span className="font-medium">Användarvillkor</span>
                </button>
                <button
                ...
                >
                  ...
                  <span className="font-medium">Cookiepolicy</span>
                </button>
                <button
                ...
                >
                  ...
                  <span className="font-medium">Tillgänglighet</span>
                </button>
              </div>
            </Card>
          </div>
          ...
          <div className="md:col-span-3">
            <Card className="p-8 apple-card border-0 shadow-sm">
              {activePolicy === "privacy" && (
                <div>
                  <h2 className="text-3xl font-bold mb-6">Integritetspolicy</h2>
                  ...
                  <Accordion type="single" collapsible className="w-full">
                    <AccordionItem value="item-1" className="border-b border-gray-200 dark:border-gray-700">
                      <AccordionTrigger className="text-lg py-4">Information vi samlar in</AccordionTrigger>
              ...
              {activePolicy === "terms" && (
                <div>
                  <h2 className="text-3xl font-bold mb-6">Användarvillkor</h2>
                  <p className="text-gray-600 dark:text-gray-400 mb-8 text-lg leading-relaxed">
              ...
              {activePolicy === "cookies" && (
                <div>
                  <h2 className="text-3xl font-bold mb-6">Cookiepolicy</h2>
                  <p className="text-gray-600 dark:text-gray-400 mb-8 text-lg leading-relaxed">
              ...
              {activePolicy === "accessibility" && (
                <div>
                  <h2 className="text-3xl font-bold mb-6">Tillgänglighetspolicy</h2>
                  <p className="text-gray-600 dark:text-gray-400 mb-8 text-lg leading-relaxed">
